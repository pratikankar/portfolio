...
const socialLinks = [
    ...
    {
      href: 'mailto:ankar.pratik@gmail.com',
      icon: <svg data-name="Layer 1" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
    ...
    {
      href: 'tel:+919403824889',
      icon: <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g data-name="Call Dial"><path d="M19.91 12.87a3.08 3.08 0 0 0-4.34 0l-1.47 1.45a1.07 1.07 0 0 1-1.5 0L9.68 11.4a1.06 1.06 0 0 1 0-1.51l1.45-1.46a3.07 3.07 0 0 0 0-4.34L8.94 1.9a3.07 3.07 0 0 0-4.34 0L2.41 4.09C-.44 6.94 1.16 13 6.07 17.93c3.76 3.75 10.41 7.07 13.84 3.66l2.19-2.19a3.07 3.07 0 0 0 0-4.34zm.78 5.13-2.19 2.17c-2 2-7 .32-11-3.65s-5.65-9-3.65-11L6 3.31a1.07 1.07 0 0 1 1.51 0c3.24 3.24 3.24 2.65.73 5.17a3.06 3.06 0 0 0 0 4.33l2.93 2.93a3.13 3.13 0 0 0 4.32 0L17 14.28a1.1 1.1 0 0 1 1.51 0l2.19 2.19a1.08 1.08 0 0 1-.01 1.53zM22 10a1 1 0 0 0 0-2 1 1 0 0 0 0 2zM18 10a1 1 0 0 0 0-2 1 1 0 0 0 0 2z"/><path d="M14 10a1 1 0 0 0 0-2 1 1 0 0 0 0 2z"/></g></svg>,
      alt: 'Call'
    },
  ];
    ...
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="lg:mb-0 lg:flex lg:flex-col">
                ...
                <div className="flex items-center pt-2 pb-4 mt-auto">
            ...
            {/* <form action="" method="POST" className="xl:pl-10 2xl:pl-20">
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder="Enter your message" required className="text-field resize-y min-h-32" rows="5"></textarea>
                </div>
