...
//                 </div>
//             </div>
//             <div className="w-11 h-11 rounded-lg grid place-items-center bg-skyu-400 text-zinc-950 shrink-0">
//                 <span className="material-symbols-outlined" aaria-hidden="true">
//                     arrow_outward
//                 </span>
//             </div>
//         </div>
